...
Этой командой мы  можем соединить воедино два потока разработки. Это значит, что нашу проделанную работу в новой ветке мы можем слить обратно в master. 
...
Последнее, что останется сделать, это соощить git, что конфликты разрешены. Для этого нужно закоммитить изменения как обычно. 
...
### Раздел про связывания локальногорепозитория с удаленным

Новын изменения от коллеги
